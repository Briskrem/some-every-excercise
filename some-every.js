...
function hasAZero(num) {
    let z = Array.from(String(num), Number)
    return z.some(function(eu){
        return eu === 0
    })
}
...
function hasNoDuplicates(arr) {
    return arr.every(function(tt){
        return arr.indexOf(tt) === arr.lastIndexOf(tt) //it has no duplicates
    })
}
